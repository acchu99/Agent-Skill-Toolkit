...
**Application:**
- **Error Handling:** Don't error out for a missing workspace or dash.
- **Formatting:** Accept dates in DD/MM/YYYY or MM/DD/YYYY.
- **Inputs:** Strip trailing/leading white workspace automatically.
...
**Example:**
```
❌ Bad: Rejecting a phone number because the user put a workspace in it.
✅ Good: Accepting the input and stripping the workspaces automatically.
