---
name: add-agent
description: Steps to add a new domain agent to the system (e.g., Pricing Agent, Logistics Agent). Use when onboarding a new agent with specs, prompts, schemas, skills, and diagrams.
disable-model-invocation: true
argument-hint: "[brand] [agent_name]"
---
