---
name: add-migration
description: Steps to create a new Supabase SQL migration following project conventions (sequential numbering, RLS, timestamps, UUIDs). Use when adding new database tables, columns, or functions.
