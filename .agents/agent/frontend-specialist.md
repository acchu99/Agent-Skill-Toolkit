...
model: inherit
skills: clean-code, design-spec, nextjs-react-expert, frontend-architecture, web-design-guidelines, tailwind-patterns, frontend-design, accessibility, data-visualization, lint-and-validate
---
